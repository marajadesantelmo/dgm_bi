...
\textbf{Filtro de saldo:} Se toman únicamente los movimientos con \texttt{TipoSaldo = 0} (debe), descartando los registros de haber. El mismo criterio se aplica a las cuentas de cargas sociales.
...
\begin{enumerate}
    ...
    \item \textbf{Exclusión de ajustes por inflación:} Se eliminan del conjunto de egresos todos los asientos cuyo campo \texttt{Detalle} contenga la cadena \texttt{INFL}, evitando que los ajustes contables por inflación distorsionen el análisis de costos operativos.
